          ...
          <table width="100%" height='100%' class="style_hidden fixed_table">
              <tr>
               ...
               <!-- <td colspan="4">
                ...
                <?=$this->lang->line('credit_note')?>
                </span>
               </center>

             <td colspan="10">                    
             
                <p style="font-size: 18px; line-height: 1.1;">  <span style="font-size: 22px;"><?php echo $store_name; ?></span> <br> 
                        ...
                        <tr>
                          ...
                          <?php if(!empty($sales_code)) { ?>
                                 <label for="" class="col-sm-2 control-label"><?= $this->lang->line('returned_against_sales_invoices'); ?><label class="text-danger"></label> </label> <br>
                                  <label class="col-sm-3 control-label" style="text-align: left; font-size: 22px;">เลขที่ : <?= $sales_code;?></label>
                                <?php } ?>
                          </td>
                      ...
                      <span>
                       ...
                       <tr>
                         <td colspan="6">
                          <div class="form-group">
                             <label for="return_note" class="col-sm-4 control-label" style="font-size: 18px;"><?= $this->lang->line('reference_no'); ?></label>    
                             <span style="font-size: 20px;">  
                               <label class="control-label  " style="font-size: 22px;">: <?= $reference_no;?></label>
                              </span>
                         </div>
                         </td>
                       </tr>
                       ...
                       <tr>
                         <td colspan="6">
                            ...
                            <span style="font-size: 20px;">           
                              <label class="control-label  " style="font-size: 22px;">: <?=$return_note;?></label>
                            </span>
                          </td>
                        </tr>  
      ...
      <tr>
         <!-- <td colspan="16" style="height:3px;"></td>       
            ...
            <tr>
                ...
                <td colspan="3" class='text-right' ><b><?php echo store_number_format( $previous_grand_total); ?></b></td>
            </tr>
           
            <tr>
                <td colspan="13" class='text-right'><b><?= $this->lang->line('total_against_enable'); ?></b></td>
                <td colspan="3" class='text-right' ><b><?php echo store_number_format( $previous_grand_total -= $grand_total); ?></b></td>
            </tr>  
            <tr>
              <td colspan="13" class='text-right'><b><?= $this->lang->line('difference'); ?></b></td>
              <td colspan="3" class='text-right' ><b><?php echo store_number_format($grand_total); ?></b></td>
            </tr>
        ...
        <!--    <?php if(!empty($tot_discount_to_all_amt !=0)){ ?>
            <tr>
              <td colspan="13" class='text-right'><b><?= $this->lang->line('discount'); ?></b>
            ...
            <tr>
                ...
                <td colspan="3" class='text-right' ><b><?php echo store_number_format($dis_tax_new - $tot_tax_amt); ?></b></td>
            </tr>  
            <tr>
                <td colspan="13" class='text-right'><b><?= $this->lang->line('tax_amount') . store_number_format($company_vat_no)." % "; ?></b></td>
                <td colspan="3" class='text-right' ><b><?php echo store_number_format(  $tot_tax_amt ) ; ?></b></td>
            </tr> 
                    ...
                    <table style="width: 100%;" class="style_hidden fixed_table">
                       ...
                       <tr>
                          ...
                          <td colspan='16' style="height:60px;">
                           ...
                           <?= $this->lang->line('invoiceTerms') .":</br>". nl2br(html_entity_decode($invoice_terms))."";?>
                          </span>          	                                  
                          </td>
