                     ...
                     <div class="box box-primary">
                        <div class="box-header with-border">
                           ...
                           <?php if($CI->permissions('warehouse_add')) { ?>
                            <div class="box-tools">
                              <a class="btn btn-block btn-success" href="<?php echo $base_url; ?>warehouse/add">
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       ...
                                       if($res1->store_id!=get_current_store_id()){
                                        echo "  <span  class='label label-default' disabled='disabled' style='cursor:disabled'>ลบไม่ได้</span>";
                                       }
