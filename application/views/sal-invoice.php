                      ...
                      <?php if(!empty($tot_price_zero_vat)) {?>
                       <tr>
                          ...
                          <th class="text-right" style="padding-left:10%;font-size: 11px;">
                             <h4><b id="subtotal_amt" name="subtotal_amt"><?php echo store_number_format($dis_non_tax);?></b> บ.</h4>
                          </th>
                       </tr>
                       <?php } ?> 
                       ...
                       <tr class=''>
                          ...
                          <th class="text-right" style="padding-left:10%;font-size: 17px;">
                             <h4><b id="subtotal_amt" name="subtotal_amt"><?=store_number_format( $dis_in_tax);?></b> บ.</h4>
                          </th>
                       </tr>
                       ...
                       <tr>
                          ...
                          <th class="text-right" style="padding-left:10%;font-size: 17px;">
                             <h4><b id="discount_to_all_amt" name="discount_to_all_amt"><?=store_number_format($tot_discount_to_all_amt);?></b> บ.</h4>
                          </th>
                       </tr>  
                       ...
                       <tr class='text-primary'>
                          <th class="text-right" style="font-size: 17px;"><?= $this->lang->line('total_zero_vat'); ?></th>
                          <th class="text-right" style="padding-left:10%;font-size: 11px;">
                             <h4><b id="subtotal_amt" name="subtotal_amt"><?php echo store_number_format( $vat_no);?></b> บ.</h4>
                          </th>
                       </tr>
                       <?php } ?> 
                       ...
                       <tr class='text-primary'>
                          <th class="text-right" style="font-size: 17px;"><b><?= $this->lang->line('before_amt') ; ?></b></th>
                            <th class="text-right" style="padding-left:10%;font-size: 17px;">
                            <h4><b id="total_amt" name="total_amt"><?=store_number_format( $vat4);?></b>  บ.</h4>
                            <th>
                         </th>
                        </tr>
                       ...
                       <tr class='text-primary'>
                          <th class="text-right" style="font-size: 17px;"><b><?= $this->lang->line('tax_amount') .( $vat_sale)." % "; ?></b></th>
                            <th class="text-right" style="padding-left:10%;font-size: 17px;">
                            <h4><b id="total_amt" name="total_amt"><?=store_number_format(  $vat);?></b> บ.</h4>
                       ...
                       <tr class='text-primary'>
                          ...
                          <th class="text-right" style="padding-left:10%;font-size: 18px;">
                             <h3 style="color:crimson ;"><b id="total_amt" name="total_amt"><?=store_number_format($grand_total);?></b> บ.</h3>
                          </th>
                       </tr>
                    </table>
