  ...
  <table autosize="1" style="overflow: wrap" id='mytable' align="center" width="100%" height='100%' cellpadding="0" cellspacing="0">
    ...
    <tfoot>
      ...
      <tr>
        ...
        <td colspan="2" class='text-right'><b><?php echo store_number_format($grand_total); ?></b> บ.</td>
      </tr>
          ...
          <tr> 
                <td colspan="16">                 
                  <span class='amt-in-word'>
                      <?= $this->lang->line('sales_man') . ": - " . nl2br($sales_note) . ""; ?>
                  </span>                    
                </td>                       
          </tr> 
            ...
            <tr>
              <td colspan="16">              
                   ...
                   <!--     <span class='amt-in-word'>
                        ...
                        <p>
                        <?= $this->lang->line(' เอกสารฉบับนี้ได้จัดทำขึ้นอย่างสมบูรณ์แล้ว โดยไม่ต้องมีลายเซ็นต์ของเจ้าหน้าที่บริษัทแต่อย่างใด') ; ?>
