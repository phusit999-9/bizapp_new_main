                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <?php if(!empty($return_code)) { ?>
                                 <label for="" class="col-sm-2 control-label"><?= $this->lang->line('return_invoice'); ?><label class="text-danger">*</label> </label>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-3">
                                       <select class="form-control select2" id="return_status" name="return_status"  style="width: 100%;" onkeyup="shift_cursor(event,'mobile')">
                                          ...
                                          ?>
              							                <option <?= $return_select; ?> value="Return">คืนสินค้า</option>
                           ...
                           <div class="row">
                                        ...
                                        <div class="col-md-8 col-md-offset-2 d-flex justify-content" >
                                         <div class="input-group">
                                                <span class="input-group-addon" title="Select Items"><i class="fa fa-barcode"></i></span>
                                                 <input type="text" class="form-control " placeholder="ชื่อสินค้า / บาร์โค้ด / รหัสสินค้า " autofocus id="item_search">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="return_note" class="col-sm-4 control-label"><?= $this->lang->line('purchase_return_note'); ?></label>    
                                          <div class="col-sm-8">
                                          ...
                                          <table  class="col-md-9">
                                           <!--  <tr>
                                             ...
                                             <tr class='text-primary'>
                                                ...
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                   <h2>
                                                    <?= $CI->currency('<b id="total_amt" name="total_amt">0.00</b>'); ?></h2>
                                                </th>
                                             </tr>
                                          </table>
                                       </div>
