...
<!-- <table align="center" width="100%" height='100%'   > -->
        ...
        <th colspan="16">
          <table width="100%" height='100%' class="style_hidden fixed_table">
              <tr>
                ...
                <td colspan="10">       
                 <br/>               
                  <b style="font-size:16px;"><?php echo $store_name; ?></b>
                  <br/>
               ...
               <?php echo (!empty(trim($company_email))) ? $this->lang->line('email').": ".$company_email."<br>" : '';?>          
                ...
                <td colspan="6">
                 ...
                 <span style="font-size: 18px; text-transform: uppercase; margin-top:20px; color:blue;"><?= $this->lang->line('purchase_invoice'); ?> (<?=$purchase_status;?>)</span>
            
                 </center>
              <!--  <center>
               <img src="<?= base_url($store_logo);?>"  height=" " width="45%"> 
               </center>-->
             </td>
              </tr>
              ...
              <tr>
                <!-- Bottom Half -->
                <td colspan="10">
                  <b style="font-size:10px;"><?= $this->lang->line('supplier'); ?></b><br/>
                  <b style="font-size:16px;"><?php echo $this->lang->line('')." ".$supplier_name; ?></b><br/> 
                  <span style="font-size: 13px;">                             
                        <?php 
   ...
   <!-- <th colspan='2' class="text-center"><?= $this->lang->line('hsn'); ?></th>-->
        ...
        <th colspan='1' class="text-center"><?= $this->lang->line('price'); ?></th>     
        <th colspan='1' class="text-center"><?= $this->lang->line('disc.'); ?></th>
       <th colspan='1' class="text-center"><?= $this->lang->line('vat'); ?></th> 
       <th colspan='1' class="text-center"><?= $this->lang->line('amount_vat'); ?></th> 
     <!--  <th colspan='1' class="text-center"><?= $this->lang->line('disc.'); ?></th>-->
 ...
 <?php
              ...
              foreach ($q2->result() as $res2) {
               ...
               //  echo "<td style='text-align: right;'>".$discount."</td>";
                  echo "<td colspan='1' class='text-right'>".store_number_format($discount_amt)."</td>";
               //  echo "<td colspan='1' class='text-right'>".$res2->tax_name."[".$str."]</td>";
                  echo "<td colspan='1' class='text-right'>".store_number_format($res2->tax)."%</td>";
                  echo "<td colspan='1' class='text-right'>".store_number_format($res2->tax_amt)."</td>";                  
     ...
     <tfoot>
            ...
            <tr class="bg-sky">
              ...
              <td colspan="1" class='text-right' ><b></td>
            ...
            <tr>
              <td colspan="14" class='text-right'><b><?= $this->lang->line('subtotal_item'); ?></b></td>
              <td colspan="2" class='text-right' ><b><?php echo store_number_format($tot_total_cost); ?></b></td>
            </tr>
                      ...
                      <!--      <span><b> <?= $this->lang->line('terms_and_conditions'); ?></b></span><br>
                         ...
                         <tr>
                          <td colspan='8' style="height:80px;">
                            <span><b> <?= $this->lang->line('approver'); ?></b></span>
                            <br/><br/><br/><br/><br/><br/>
                            <p style="font-size: 14px">วันที่............./......................../............</p>
                          </td>
                          <td colspan='8'>
                            <span><b> <?= $this->lang->line('authorised_signature'); ?></b></span>
                            <span><b> <?= $this->lang->line('authorised_signature_e'); ?></b></span>
