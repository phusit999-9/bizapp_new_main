                           ...
                           <div class="row">
                                        ...
                                        <div class="col-md-8 col-md-offset-2 d-flex justify-content" >
                                          <div class="input-group">
                                                <span class="input-group-addon" title="Select Items"><i class="fa fa-barcode"></i></span>
                                                 <input type="text" class="form-control " placeholder="พิมพ์ชื่อสินค้า/สแกนบาร์โค้ด/รหัสสินค้า" autofocus id="item_search">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="sales_note" class="col-sm-4 control-label"><?= $this->lang->line('invoice_Terms'); ?></label>    
                                          <div class="col-sm-8">
                                          ...
                                          <table  class="col-md-9">
                                             ...
                                             <tr>
                                                ...
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                   <h4><b id="subtotal_amt" name="subtotal_amt">0.00</b> บ.</h4>
                                                </th>
                                             </tr>
                                             ...
                                             <tr>
                                                ...
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                  <h4><b id="discount_to_all_amt" name="discount_to_all_amt">0.00</b> บ.</h4>
                                                  
                                                </th>
                                             </tr>
                                    
                                           <!--  <tr  class='text-primary'>
                                                <th class="text-right" style="font-size: 24px;"><?= $this->lang->line('grand_total'); ?></th>
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                ...
                                                <?php 
                                                  if(isset($sales_id)){
                                                    ...
                                                    if($q3->num_rows()>0){
                                                      ...
                                                      echo "<tr class='text-right text-bold'><td colspan='4' >รวมเงิน</td><td data-rowcount='$i' id='paid_amt_tot'>".store_number_format($total_paid)."</td><td></td></tr>";
                                                    }
                                                    else{
                                    ...
                                    <div class="col-md-12">
                                     ...
                                     <!-- /.box -->
                                       ...
                                       <div class="box-body ">
                                          ...
                                          <div class="box box-solid bg-gray">    <span class="text-info"> ขายเครดิต ( จำนวนเงินเป็น 0  เลือกวิธีชำระเงิน  แล้วกด  Save )</span> 
                                            <div class="box-body">                                         
                                              <div class="row">                                        
                                                <div class="col-md-4">
                                                  <div class="">
                                        ...
                                        <div class="row cheque_div" style="display: none;">
                                                ...
                                                <div class="col-md-8">
                                                  ...
                                                  <label for="cheque_number"><?= $this->lang->line('cheque_number'); ?></label>
                                                    <input type="text" class="form-control" id="cheque_number" name="cheque_number" placeholder="หมายเลขเช็ค" >
                                               ...
                                               <div class="col-md-4">
                                                  ...
                                                  <label for="cheque_period"><?= $this->lang->line('cheque_period_days'); ?></label>
                                                    <input type="text" class="form-control only_currency" id="cheque_period" name="cheque_period" placeholder="วันที่ขึ้นเงินได้  นับจากวันรับเช็ค" >
