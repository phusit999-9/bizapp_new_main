                      ...
                      <?= form_open('#', array('class' => 'form', 'id' => 'items-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                        ...
                        <div class="box-body">
                          ...
                          <div class="row">
                           ...
                           <div class="row">
                              <div class="form-group col-md-4">
                                 <label for="price"><?= $this->lang->line('price'); ?> (ค่าใช้จ่าย)<span class="text-danger">*</span></label>
                                 ...
                                 <span id="" style="display:show" class="text-primary">ป้อน "0", ถ้าไม่มีค่าใช้จ่าย</span>
                              </div>
                              <div class="form-group col-md-4">
