  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?= $this->lang->line('deposit_list'); ?></li>
      </ol>
    </section>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="col-md-2 pull-right">
                ...
                <div class="box-tools">
                <a class="btn btn-block btn-success" href="<?php echo $base_url; ?>money_deposit/add">
                <i class="fa fa-plus"></i> <?= $this->lang->line('new_deposit'); ?></a>
              </div>
               <?php } ?>
              </div>
              </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                       <label for="deposit_date"><?= $this->lang->line('deposit_date'); ?> </label></label>
...
<script type="text/javascript">
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('money_deposit/ajax_list')?>",
            "type": "POST",
            "data": {
...
<script src="<?php echo $theme_link; ?>js/accounts/money_deposit.js"></script>
