            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary ">
                <div class="box-header with-border">
                  <h3 class="box-title">กรุณาป้อนข้อมูล
                  </h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-3">
                        <div class="input-group date">
                          ...
                          <input type="text" class="form-control pull-right datepicker"  id="deposit_date" name="deposit_date" readonly onkeyup="shift_cursor(event,'sales_status')" value="<?= $deposit_date;?>">
                        </div>
                        <span id="deposit_date_msg" style="display:none" class="text-danger">
                        </span>
                      </div>
                      ...
                      <div class="col-sm-3">
                        ...
                        <span id="reference_no_msg" style="display:none" class="text-danger">
                        </span>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-3">
                        ...
                        <span id="credit_account_id_msg" style="display:none" class="text-danger">
                        </span>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-3">
                        ...
                        <span id="amount_msg" style="display:none" class="text-danger">
                        </span>
                      </div>
                      ...
                      <div class="col-sm-3">
                        ...
                        <span id="note_msg" style="display:none" class="text-danger">
                        </span>
                      </div>
                    </div>
                  </div>
...
?>
                      <div class="col-md-3 col-md-offset-3">
                        <button type="button" id="<?php echo $btn_id;?>" class=" btn btn-block btn-primary" title="Save Data">
                          <?php echo $btn_name;?>
                        </button>
                      </div>
                      <div class="col-sm-3">
                        <a href="<?=base_url('dashboard');?>">
                          <button type="button" class="col-sm-3 btn btn-block btn-info close_btn" title="Go Dashboard">ปิด
                          </button>
                        </a>
                      </div>
                    </div>
