    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          ...
          <address>
            <strong><?php echo  $store_name; ?></strong> <?php echo (!empty(trim($company_vat_no)) && vat_number()) ? $this->lang->line('')." ".$company_vat_no." " : '';?><br>
            <?php echo  $company_address; ?>
           <br>
            <?php echo (!empty(trim($company_gst_no))) ? $this->lang->line('gst_number_tax')." ".$company_gst_no."<br> " : '';?>
            <?= $this->lang->line('mobile'); ?>: <?php echo  $company_phone; ?>,
