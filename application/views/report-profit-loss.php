                     ...
                     <div class="box box-primary">
                        ...
                        <div class="box-body table-responsive no-padding">
                           <table class="table table-bordered table-hover " id="report-data" >
                              <!-- Total Opening Stock -->
                              <tr>
                              <td colspan="2" class="text-bold font-italic text-primary"><?= $this->lang->line('expense'); ?></td>
                              ...
                              <tr>
                                 <td><?= $this->lang->line('total_purchase_all'); ?></td>
                                 <td class="text-right text-bold total_purchase_amt bg-gray"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                              ...
                              <tr>
                                 <td><?= $this->lang->line('total_purchase_return_all'); ?></td>
                                 <td class="text-right text-bold pur_return_total_all bg-gray"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                     ...
                     <div class="box">
                        ...
                        <div class="box-body table-responsive no-padding">
                           <table class="table table-bordered table-hover " id="report-data-4" >
                              ...
                              <!-- Total Sales -->
                              <tr>
                                 <td><?= $this->lang->line('total_item_price'); ?> </td>
                                 <td class="text-right text-bold total_sale"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                              <!-- Total Sales Tax -->
                          <!--    <tr>
                                ...
                                <!-- Total Sales Doscount item -->
                              <tr>
                                 <td><?= $this->lang->line('total_discount_item'); ?></td>
                                 <td class="text-right text-bold sales_discount_item"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                              <!-- Total Sales Doscount all -->
                              <tr>
                            ...
                            <!--  <tr>
                              ...
                              <tr>
                                 ...
                                 <td class="text-right text-bold text-danger sal_total bg-gray"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                              ...
                              <tr>
                                 <td><?= $this->lang->line('total_vat'); ?></td>
