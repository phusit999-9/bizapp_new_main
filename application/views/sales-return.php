                           ...
                           <div class="box-body">
                              ...
                              <div class="form-group">
                                <?php if(!empty($sales_code)) { ?>
                                 <label for="" class="col-sm-2 control-label"><?= $this->lang->line('returned_against_sales_invoices'); ?><label class="text-danger"></label> </label>
                              ...
                              <div class="form-group">
                                <?php if(!empty($return_code)) { ?>
                                 <label for="" class="col-sm-2 control-label"><?= $this->lang->line('return_invoice_no'); ?><label class="text-danger"></label> </label>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-3">
                                       <select class="form-control select2" id="return_status" name="return_status"  style="width: 100%;" onkeyup="shift_cursor(event,'mobile')">
                                          ...
                                          ?>
                                            <option <?= $return_select; ?> value="Return">รับคืนสินค้า</option>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="return_note" class="col-sm-4 control-label"><?= $this->lang->line('return_note'); ?></label>    
                                          <div class="col-sm-8">
