                                 ...
                                 <div class="box-body">
                                    <div class="row">
                                       <div class="col-md-5">
                                          ...
                                          <div class="form-group">
                                             <label for="mobile" class="col-sm-4 control-label"><?= $this->lang->line('phone'); ?><label class="text-danger">*</label></label>
                                             <div class="col-sm-8">
                                          ...
                                          <div class="form-group">
                                             <label for="phone" class="col-sm-4 control-label"><?= $this->lang->line('mobile'); ?></label>
                                             <div class="col-sm-8">
                                          ...
                                          <?php if (vat_number()) { ?>
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                   <input type="text" class="form-control" id="vat_no" name="vat_no" placeholder="เลข 7 คือ Vat = 7%  / เลข 0 คือไม่มีภาษีมูลค่าเพิ่ม" value="<?php print $vat_no; ?>" onkeyup="shift_cursor(event,'store_website')">
