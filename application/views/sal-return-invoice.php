            ...
            <?php
              ...
              <div class="alert alert-success text-left">
                ...
                <strong>
                  ...
                  if (!empty($sales_id)) {
                    echo "<i class='fa fa-fw fa-hand-o-right'></i>คืนสินค้าจากการขาย [รหัสการขายคือ " . $this->db->select('sales_code')->where('id', $sales_id)->get('db_sales')->row()->sales_code . '].';
                    //echo "<br>";
                  } else {
                    echo '<i class="fa fa-fw fa-hand-o-right"></i>ไปที่เอกสารลดหนี้.';
                  }
                  ?>
                </strong>
              </div>
          ...
          <div class="row">
            <div class="col-xs-12">
              <h2 class="page-header">
                ...
                <small class="pull-right">วันที่: <?php echo  show_date($return_date) . " " . $created_time; ?></small>
              </h2>
            </div>
            <!-- /.col -->
          </div>
            ...
            <div class="col-xs-12 table-responsive">
              <table class="table  records_table table-bordered">
                ...
                //    $tot_price = $price_per_unit * $res2->sales_qty;
                    $unit_cost = $res2->total_cost / $res2->return_qty;
                    ...
                    <table class="table table-hover table-bordered" style="width:100%" id="">
                      ...
                      <tbody>
                        ...
                        if (isset($return_id)) {
                          ...
                          echo "<tr><td colspan='6' class='text-center text-bold'>กำลังจะชำระเงิน!!</td></tr>";
                        }
                        ?>
                      </tbody>
                    </table>
                  ...
                  <div class="form-group">
                    ...
                    <table class="col-md-11">
                      ...
                      <?php if(!empty($tot_price_zero_vat)) {?>
                       <tr>
                          ...
                          <th class="text-right" style="padding-left:10%;font-size: 11px;">
                             <h4><b id="subtotal_amt" name="subtotal_amt"><?php echo store_number_format( $item_return_no_vat);?></b>บ.</h4>
                          </th>
                       </tr>
                       <?php } ?> 
                       ...
                       <tr class='text-primary'>
                          <th class="text-right" style="font-size: 17px;"><b><?= $this->lang->line('before_amt') ; ?></b></th>
                            ...
                            <h4><b id="total_amt" name="total_amt"><?=store_number_format( $item_return );?></b> บ.</h4>
                            <th>
                         </th>
                        </tr> 
                       <tr class='text-primary'>
                          <th class="text-right" style="font-size: 17px;"><b><?= $this->lang->line('tax_amount') .( $company_vat_no)." % "; ?></b></th>
                            <th class="text-right" style="padding-left:10%;font-size: 17px;">
                            <h4><b id="total_amt" name="total_amt"><?=store_number_format( $tot_tax_amt);?></b> บ.</h4>
                            <th>
                         </th>
                        </tr> 
                      ...
                      <tr class='text-primary'>
                        ...
                        <th class="text-right" style="padding-left:10%;font-size: 17px;">
                          <h3><b id="total_amt" name="total_amt"><?= store_number_format($grand_total); ?></b> บ.</h3>
                        </th>
                      </tr>
                    </table>
                  </div>
