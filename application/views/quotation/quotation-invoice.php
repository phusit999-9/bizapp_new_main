    ...
    <section class="invoice">
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table  records_table table-bordered">
            ...
            <tr>
              ...
              <th class='text-center'><?= $this->lang->line('net_cost'); ?></th>
      ...
      <div class="row no-print">
        <div class="col-xs-6">
          ...
          <a href="<?php echo $base_url; ?><?=$str2;?><?php echo  $quotation_id ?>" class="btn btn-danger">
        ...
        <?php } ?>
          ...
          <?php if($CI->permissions('sales_add') && $sales_status=='') { ?>
            <a href="<?php echo $base_url; ?>sales/quotation/<?php echo  $quotation_id ?>" class="btn btn-success">
            <i class="fa  fa-undo"></i> แปลงเป็นการขาย
          </a>
          <?php }else{ ?>
            <a href="<?php echo $base_url; ?>sales/invoice/<?=get_sales_id_of_quotation($quotation_id)?>" class="btn btn-info">
            <i class="fa  fa-eye"></i> มุมมองใบเสร็จขาย
          </a>
          <?php } ?>
          
          <a href="<?php echo $base_url; ?>quotation/print_invoice/<?php echo  $quotation_id ?>" target="_blank" class="btn btn-primary">
