                  ...
                  <div class="col-md-12">
                     ...
                     <div class="box box-primary ">
                        <div class="box-header with-border">
                           <h3 class="box-title">กรุณาเลือกวันที่ </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                           ...
                           <table class="table table-bordered table-hover " id="report-data" >
                              <thead>
                                 <tr class="bg-success">
                                    ...
                                    <th class="text-center"><?= $this->lang->line('sales_date'); ?></th>
                                    <th class="text-center"><?= $this->lang->line('customer_name'); ?></th>
                                    <th class="text-center"><?= $this->lang->line('vat_number'); ?></th>
                                    <th class="text-center"><?= $this->lang->line('discount_on_all'); ?></th>
                                
                              <!--      <th class="text-center"><?= $this->lang->line('in_vat'); ?></th>    -->                           
                                    <th class="text-center"><?= $this->lang->line('tax_amount'); ?></th>                                  
                                    <th class="text-center"><?= $this->lang->line('invoice_total'); ?></th>
                                 </tr>
                              </thead>
                              <tbody id="tbodyid">
                              </tbody>
