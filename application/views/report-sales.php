                           ...
                           <table class="table table-bordered table-hover " id="report-data" >
                              <thead>
                                 <tr class="bg-success">
                                    ...
                                    <th class='text-center' style=""><?= $this->lang->line('store_name'); ?></th>
                                    <?php } ?>
                                    ...
                                    <th class='text-center' style=""><?= $this->lang->line('sales_date'); ?></th>
                                    <th class='text-center' style=""><?= $this->lang->line('customer_id'); ?></th>
                                    <th class='text-center' style=""><?= $this->lang->line('customer_name'); ?></th>
                                    <th class='text-center' style=""><?= $this->lang->line('invoice_total'); ?>(<?= $CI->currency(); ?>)</th>
                                    <th class='text-center' style=""><?= $this->lang->line('paid_amount'); ?>(<?= $CI->currency(); ?>)</th>
                                    <th class='text-center' style=""><?= $this->lang->line('due_amount'); ?>(<?= $CI->currency(); ?>)</th>   
                            <!--       <th class='text-center' style=""><?= $this->lang->line('vat_amount'); ?>(<?= $CI->currency(); ?>)</th>     -->                    
                                    <th class='text-center' style=""><?= $this->lang->line('user'); ?></th>
                                 </tr>
                              </thead>
                              <tbody id="tbodyid">
                              </tbody>
