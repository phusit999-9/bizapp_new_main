...
<!-- <table align="center" width="100%" height='100%'   > -->
        ...
        <th colspan="16">
          <table width="100%" height='100%' class="style_hidden fixed_table">
              <tr>
                ...
                <?=$this->lang->line('return_pur_invoice')?>
                </span>
                </center>
    ...
    <!--    <th colspan='1' class="text-center"><?= $this->lang->line('tax_vat'); ?></th> -->
        <th colspan='1' class="text-center"><?= $this->lang->line('total_vat'); ?></th>
...
<tfoot>
  ...
  <tr class="bg-sky">
    ...
    <td colspan="2" class='text-bold text-center'></td>
  ...
  <td colspan="13" class='text-right'><b><?= $this->lang->line('tax_item'); ?></b></td>
    <td colspan="3" class='text-right' ><b><?php echo store_number_format($tot_total_cost - $tot_tax_amt ); ?></b></td>
  </tr>

  <td colspan="13" class='text-right'><b><?= $this->lang->line('vat_amount'); ?></b></td>
  ...
  <tr>
    <td colspan="16">
      <span class='amt-in-word'>
        <?= $this->lang->line('purchase_return_note') .":<b>". nl2br($return_note)."</b>";?>
    </span>  
    </td>
  </tr>
                       ...
                       -->
                         <tr>
                          <td colspan='8' style="height:80px;">
                            <span><b> <?= $this->lang->line('supplier_return'); ?></b></span>
                          </td>
                          <td colspan='8'>
