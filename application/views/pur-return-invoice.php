                 ...
                 <div class="form-group">
                    ...
                    <table  class="col-md-11">
                       <tr class='text-primary'>
                          <th class="text-right" style="font-size: 17px;"><?= $this->lang->line('tax_item'); ?></th>
                          <th class="text-right" style="padding-left:10%;font-size: 17px;">
                             <h4><b id="subtotal_amt" name="subtotal_amt"><?=$CI->currency($grand_total - $tot_tax_amt);?></b> บ.</h4>
                          </th>
                       </tr>
                       ...
                       <tr class='text-primary'>
                          ...
                          <th class="text-right" style="padding-left:10%;font-size: 17px;">
                             <h3><b id="total_amt" name="total_amt"><?=$CI->currency($grand_total);?></b> บ.</h3>
                          </th>
                       </tr>
                    </table>
                 </div>
