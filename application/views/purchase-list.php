  ...
  <!-- ********** ALERT MESSAGE START******* -->
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="info-box " >
            ...
            <div class="info-box-content">
              <span class="info-box-text"><?=$CI->currency($pur_total);?></span>
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="info-box " >
            ...
            <div class="info-box-content">
              <span class="info-box-text"><?=$CI->currency($tot_paid_amt);?></span>
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="info-box " >
            ...
            <div class="info-box-content">
              <span class="info-box-text"><?=$CI->currency($purchase_due_total);?></span>
