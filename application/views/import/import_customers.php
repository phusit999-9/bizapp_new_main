                        ...
                        <form class="form-horizontal" id="import-form" enctype="multipart/form-data" method="POST">
                           ...
                           <div class="box-footer">
                              <div class="col-sm-8 text-center">
                                 <div class="col-md-3 ">
                                    <button type="button" id="import" class=" btn btn-block btn-primary" title="Save Data"><i class="fa fa-arrow-circle-o-left "></i>นำเข้า</button>
                                 </div>
                                 <div class="col-sm-3">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?= base_url('import/download/customers');?>"><button type="button" class="btn btn-success pull-right btnExport" title="Download Data in Excel Format"><?= $this->lang->line('download_example_format'); ?></button>
              </a>
            </div>
            <!-- /.box-header -->
