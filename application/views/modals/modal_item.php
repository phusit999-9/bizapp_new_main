                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                          ...
                          <div class="col-md-4">
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="m_item_name" name="m_item_name" placeholder="ชื่อสินค้า" >
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4">
                            ...
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <select class="form-control " id="m_item_group" name="m_item_group"  style="width: 100%;">
                                    <option  value="Single">มาตรฐาน</option>
                          ...
                          <div class="col-md-4">
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control only_currency" id="m_price" name="m_price" placeholder="ราคาสินค้าไม่รวมภาษี">
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" class="btn btn-primary add_item">บันทึก</button>
                    </div>
                  </div>
                  <!-- /.modal-content -->
                </div>
