    ...
    <nav class="navbar navbar-static-top">
      <!-- Sidebar toggle button-->
       <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
        <span class="sr-only">Toggle navigation</span>
	     ...
	     <div class="collapse navbar-collapse pull-left" id="navbar-collapse">  
          ...
          <div class="btn-group hidden-xs">
            <a href="#" class="btn navbar-btn bg-green dropdown-toggle " data-toggle="dropdown" aria-expanded="false"  style=" margin-left:15px">
        ...
        <?php if(!is_user()){?>
           <div class="btn-group hidden-xs" style="margin-left:15px">
            <a href="#" class="btn navbar-btn bg-purple dropdown-toggle " data-toggle="dropdown" aria-expanded="false" style="">
            ...
            <li class="report-stock-active-li"><a href="<?php echo $base_url; ?>reports/stock" ><h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('stock_report'); ?></span></h4>
              </a></li>
            <?php } ?>
           

            <?php if($CI->permissions('profit_report')) { ?>
            <li class="report-profit-loss-active-li"><a href="<?php echo $base_url; ?>reports/profit_loss" > <h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('profit_and_loss_report'); ?></span></h4>
              </a></li>
            <?php } ?>
           
            <?php if($CI->permissions('expense_report')) { ?>
            <li class="report-expense-active-li"><a href="<?php echo $base_url; ?>reports/expense" ><h4><i class="fa fa-files-o text-yellow"></i> <span ><?= $this->lang->line('expense_report'); ?></span></h4></a></li>
            <?php } ?>

            <?php if($CI->permissions('purchase_payments_report')) { ?>
            <li class="report-purchase-payments-active-li"><a href="<?php echo $base_url; ?>reports/purchase_payments" ><h4><i class="fa fa-files-o text-yellow"></i> <span ><?= $this->lang->line('purchase_payments_report'); ?></span></h4></a></li>
            <?php } ?>
            <?php if($CI->permissions('sales_payments_report')) { ?>
            <li class="report-sales-payments-active-li"><a href="<?php echo $base_url; ?>reports/sales_payments" ><h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('sales_payments_report'); ?></span></h4></a></li>  
            <?php } ?>
            <?php if($CI->permissions('delivery_sheet_report') && false) { ?>
            <li class="report-delivery-sheet-active-li"><a href="<?php echo $base_url; ?>reports/delivery_sheet" ><h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('delivery_sheet_report'); ?></span></h4></a></li>
            <?php } ?>

            <?php if($CI->permissions('load_sheet_report') && false) { ?>
            <li class="report-load-sheet-active-li"><a href="<?php echo $base_url; ?>reports/load_sheet" ><h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('load_sheet_report'); ?></span></h4></a></li>
            <?php } ?>

            <?php if($CI->permissions('sales_report')) { ?>
            <li class="report-sales-active-li"><a href="<?php echo $base_url; ?>reports/sales" ><h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('sales_report'); ?></span></h4></a></li>
            <?php } ?>
           
            <?php if($CI->permissions('purchase_report')) { ?>
            <li class="report-purchase-active-li"><a href="<?php echo $base_url; ?>reports/purchase" ><h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('purchase_report'); ?></span></h4></a></li>
            <?php } ?>

            <?php if($CI->permissions('sales_tax_report')) { ?>
            <li class="report-sales-tax-active-li"><a href="<?php echo $base_url; ?>reports/sales_tax" ><h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('sales_tax_report'); ?></span></h4></a></li>
            <?php } ?>

            <?php if($CI->permissions('purchase_tax_report')) { ?>
            <li class="report-purchase-tax-active-li"><a href="<?php echo $base_url; ?>reports/purchase_tax" ><h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('purchase_tax_report'); ?></span></h4></a></li>
            <?php } ?>
           
            
            <?php if($CI->permissions('customer_orders_report')) { ?>
            <li class="report-customer-orders-active-li"><a href="<?php echo $base_url; ?>reports/customer_orders" ><h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('customer_orders'); ?></span></h4></a></li>
            <?php } ?>

            <?php if($CI->permissions('sales_summary_report')) { ?>
            <li class="report-sales-summary-active-li"><a href="<?php echo $base_url; ?>reports/sales_summary" ><h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('sales_summary_report'); ?><span class="pull-right-container">            
              </span></h4></a></li>
            <?php } ?>
                      
            <?php if($CI->permissions('sales_return_report')) { ?>
            <li class="report-sales-return-active-li"><a href="<?php echo $base_url; ?>reports/sales_return" ><h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('sales_return_report'); ?></span></h4>
              </a></li>
            <?php } ?>
          
            <?php if($CI->permissions('purchase_return_report')) { ?>
            <li class="report-purchase-return-active-li"><a href="<?php echo $base_url; ?>reports/purchase_return" ><h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('purchase_return_report'); ?></span></h4>
              </a></li>
            <?php } ?>
               
            <?php if($CI->permissions('seller_points_report')) { ?>
            <li class="report-seller-points-active-li"><a href="<?php echo $base_url; ?>reports/seller_points" ><h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('seller_points_report'); ?></span></h4></a></li>
            <?php } ?>
                      
            <?php if($CI->permissions('stock_transfer_report')) { ?>
            <li class="report-stock-transfer-active-li"><a href="<?php echo $base_url; ?>reports/stock_transfer" ><h4><i class="fa fa-files-o text-yellow"></i> <span><?= $this->lang->line('stock_transfer_report'); ?><span class="pull-right-container"></h4>            
              </span></a></li>
            <?php } ?>
        ...
        <li>
            ...
            <li class=""><a href="<?php echo $base_url; ?>customers/" title="View Customers List"><i class="fa  fa-group  text-aqua " ></i> <span><?= $this->lang->line('customers_list'); ?></span></a></li>
            <?php } ?>
                               
            <?php if($CI->permissions('items_view')) { ?>
            <li class=""><a href="<?php echo $base_url; ?>items/" title="View Items List"><i class="fa  fa-cubes text-aqua " ></i> <span><?= $this->lang->line('items_list'); ?></span></a></li>
            <?php } ?>
           
            <?php if($CI->permissions('sales_view')) { ?>
            <li class=""><a href="<?php echo $base_url; ?>sales" title="View Sales List!"><i class="fa fa-list text-aqua" ></i> <span><?= $this->lang->line('sales_list'); ?></span></a></li>
            <?php } ?>
            </li>
           ...
           <a href="<?php echo $base_url; ?>sales/add" class="btn navbar-btn bg-blue dropdown-toggle "  style=" margin-left:15px">
           <i class="fa fa-plus-square-o text-yellow"></i>.SALES </a>
           <?php } ?>   
          
         
           <?php if(!is_user() && $CI->permissions('pos')) { ?>
          <a href="<?php echo $base_url; ?>pos" class="btn navbar-btn bg-green dropdown-toggle "  style=" margin-left:15px">
           <i class="fa fa-shopping-cart text-yellow"></i>..POS </a>
           <?php } ?>
           ...
           <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo $base_url; ?>users/edit/<?= $this->session->userdata('inv_userid'); ?>" class="btn btn-default btn-flat">โปรไฟล์</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo $base_url; ?>logout" class="btn btn-default btn-flat">ออกจากระบบ</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <!-- <li class="header">SALES</li> -->
      <li class="pos-active-li sales-list-active-li sales-active-li sales-return-active-li sales-return-list-active-li sales-payments-list-active-li treeview">
          <a href="#">
            <i class=" fa fa-shopping-cart text-aqua"></i> <span style="color:gold"><?= $this->lang->line('sales'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="sales-active-li"><a href="<?php echo $base_url; ?>sales/add"><i class="fa fa-plus-square-o text-yellow "></i> <span><?= $this->lang->line('add_sale'); ?></span></a></li>
        <?php } ?>
        
         <?php if($CI->permissions('pos')) { ?>
        <li class="pos-active-li"><a href="<?php echo $base_url; ?>pos"><i class="fa fa-plus-square-o text-yellow "></i> <span>POS</span></a></li>
         <?php } ?>
        ...
        <li class="sales-return-list-active-li "><a href="<?php echo $base_url; ?>sales_return"><i class="fa fa-list "></i> <span><?= $this->lang->line('sales_return_view'); ?></span>
              </a></li>
        <?php } ?>
    ...
    <li class="list-active-li create-active-li treeview">
          <a href="#">
            <i class=" fa fa-dollar  text-aqua"></i> <span style="color:  "><?= $this->lang->line('advance'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
    ...
    <li class="pos-active-li quotation_list-active-li quotation-active-li quotation-return-active-li quotation-return-list-active-li treeview">
          <a href="#">
            <i class=" fa fa-calendar-plus-o text-aqua"></i> <span style="color: "><?= $this->lang->line('quotation'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
    ...
    <li class="accounts_list-active-li accounts-active-li journal-active-li journal_list-active-li money_transfer-active-li money_transfer_list-active-li money_deposit-active-li money_deposit_list-active-li cash_transactions-active-li treeview">
          <a href="#">
            <i class="fa fa-th-large text-aqua"></i> <span style="color:gold"><?= $this->lang->line('accounts'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
       ...
       <li class="expense-list-active-li expense-active-li expense-category-active-li expense-category-list-active-li treeview">
          <a href="#">
            <i class="fa fa-minus-circle text-aqua"></i> <span style="color: "><?= $this->lang->line('expenses'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li class="expense-category-list-active-li "><a href="<?php echo $base_url; ?>expense/category"><i class="fa fa-list "></i> <span><?= $this->lang->line('category_ex'); ?></span></a></li>
            <?php } ?>
   ...
   <!--
    ...
    <li class="coupon-active-li treeview">
          <a href="#">
            <i class=" fa fa-tags text-aqua"></i> <span style="color: "><?= $this->lang->line('coupons'); ?><span class="">
    ...
    <li class="purchase-list-active-li purchase-active-li purchase-returns-active-li purchase-returns-list-active-li treeview treeview2 ">
          <a href="#">
            <i class="fa fa-cube text-aqua"></i> <span style="color:gold "><?= $this->lang->line('purchases'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
    ...
    <?php if(!is_user()){?>
        ...
        <li class="items-list-active-li items-active-li  category-view-active-li category-active-li brand-active-li brand-view-active-li labels-active-li import_items-active-li services-active-li import_services-active-li variants-active-li variants_list-active-li services-active-li treeview">
          <a href="#">
            <i class="fa fa-cubes text-aqua"></i> <span style="color:cyan"><?= (service_module()) ? $this->lang->line('items') : $this->lang->line('items'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li class="items-list-active-li"><a href="<?php echo $base_url; ?>items"><i class="fa fa-list "></i> <span style="color: "><?= $this->lang->line('items_list'); ?></span></a></li>
            <?php } ?>
            ...
            <li class="variants_list-active-li"><a href="<?php echo $base_url; ?>variants/view"><i class="fa fa-list "></i> <span style="color: "><?= $this->lang->line('variants_list'); ?></span></a></li>
            <?php } ?>
    ...
    <li class="pos-active-li stock_adjustment_list-active-li stock_adjustment-active-li stock_adjustment-return-active-li stock_adjustment-return-list-active-li stock_transfer-active-li stock_transfer_list-active-li treeview">
          <a href="#">
            <i class=" fa fa-hourglass text-aqua"></i> <span style="color: "><?= $this->lang->line('stock'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
    ...
    <li class="customers-view-active-li customers-active-li import_customers-active-li suppliers-list-active-li suppliers-active-li import_suppliers-active-li treeview">
          <a href="#">
            <i class="fa fa-group text-aqua"></i> <span style="color: "><?= $this->lang->line('contacts'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
    ...
    <li class="report-sales-active-li report-sales-return-active-li report-purchase-active-li report-purchase-return-active-li report-expense-active-li report-stock-active-li report-purchase-payments-active-li report-sales-item-active-li report-sales-payments-active-li report-expired-items-active-li report-supplier_items-active-li report-seller-points-active-li report-sales-tax-active-li report-purchase-tax-active-li  report-delivery-sheet-active-li report-load-sheet-active-li report-return-item-active-li report-sales-active-li report-stock-transfer-active-li reports-menu report-sales-summary-active-li report-sales-return-payments-active-li treeview">
          <a href="#">
            <i class="fa fa-bar-chart text-aqua"></i> <span style="color:gold "><?= $this->lang->line('reports'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <?php if($CI->permissions('stock_report')) { ?>
            <li class="report-stock-active-li"><a href="<?php echo $base_url; ?>reports/stock" ><i class="fa fa-files-o " style="color: bisque"></i> <span ><?= $this->lang->line('stock_report'); ?></span>
              </a></li>
            <?php } ?>

            <?php if($CI->permissions('profit_report')) { ?>
            <li class="report-profit-loss-active-li"><a href="<?php echo $base_url; ?>reports/profit_loss" ><i class="fa fa-files-o " style="color: bisque"></i> <span ><?= $this->lang->line('profit_and_loss_report'); ?></span>
              </a></li>
            <?php } ?>
           
            <?php if($CI->permissions('expense_report')) { ?>
            <li class="report-expense-active-li"><a href="<?php echo $base_url; ?>reports/expense" ><i class="fa fa-files-o " style="color: "></i> <span ><?= $this->lang->line('expense_report'); ?></span></a></li>
            <?php } ?>

            <?php if($CI->permissions('purchase_payments_report')) { ?>
            <li class="report-purchase-payments-active-li"><a href="<?php echo $base_url; ?>reports/purchase_payments" ><i class="fa fa-files-o " style="color: "></i> <span ><?= $this->lang->line('purchase_payments_report'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('sales_payments_report')) { ?>
            <li class="report-sales-payments-active-li"><a href="<?php echo $base_url; ?>reports/sales_payments" ><i class="fa fa-files-o " style="color: "></i> <span ><?= $this->lang->line('sales_payments_report'); ?></span></a></li>  
            <?php } ?>
    ...
    <li class=" site-settings-active-li  change-pass-active-li dbbackup-active-li  tax-active-li currency-view-active-li  store_profile-active-li currency-active-li  database_updater-active-li tax-list-active-li units-list-active-li unit-active-li payment_types_list-active-li payment_types-active-li gateways-active-li package-active-li subscription-active-li  subscription-list-active-li  package-list-active-li sms-api-active-li smtp-active-li treeview">
          <a href="#">
            <i class="fa fa-gears text-aqua"></i> <span style=" "><?= $this->lang->line('settings'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li><a href="https://youtube.com/@erp-shop" target="_blank" ><i class="fa fa-book text-green"></i> <span><?= $this->lang->line('help'); ?></span></a></li>
        <?php } ?>
      </ul>
    </section>
    <!-- /.sidebar -->
