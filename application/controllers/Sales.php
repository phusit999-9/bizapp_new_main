...
class Sales extends MY_Controller {
	...
	public function ajax_list()
	{
		...
		foreach ($list as $sales) {
			...
			$info .= (!empty($sales->return_bit)) ? "<br><span class='label label-danger' style='cursor:pointer'><i class='fa fa-fw fa-undo'></i>คืนสินค้า</span>" : '';
					...
					$str2 = '<div class="btn-group" title="View Account">
										...
										<!-- <li>
												<a title="Take Print" target="_blank" onclick="printTemplate(\''.$print_url.'\')">
													<i class="fa fa-fw fa-print text-blue"></i>ใบกำกับภาษี/ส่งของ
												</a>
											</li> -->
											<li>
												<a title="Download PDF" target="_blank" href="'.base_url().'pdf/sales/'.$sales->id.'">
													<i class="fa fa-fw fa-file-pdf-o text-blue"></i>ใบกำกับภาษีอย่างย่อ
												</a>
											</li>
											<li>
												<a style="cursor:pointer" title="Print POS Invoice ?" onclick="print_invoice('.$sales->id.')">
													<i class="fa fa-fw fa-file-text text-blue"></i>ใบเสร็จ
												</a>
											</li>';
											...
											$str2.='<li>
												<a title="Sales Return" href="'.base_url().'sales_return/add/'.$sales->id.'">
													<i class="fa fa-fw fa-undo text-blue"></i>รับคืนสินค้า
												</a>
											</li>';
