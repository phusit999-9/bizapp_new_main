...
class Sales_payments extends MY_Controller {
	...
	public function ajax_list()
	{
		...
		foreach ($list as $sales) {
			...
			$str = (!empty($sales->cheque_number)) ? "<br>Cheque no. :".$sales->cheque_number."<br>ช่วงเวลา(วัน) :".$sales->cheque_period."<br>สถานะ :".
										...
										<ul role="menu" class="dropdown-menu dropdown-light pull-right">';
											...
											$str2.='<li>
												<a title="Update Cheque Status" class="pointer" onclick="update_cheque_status('.$sales->id.')" >
													<i class="fa fa-fw fa-hourglass-half text-blue"></i>อัพเดทสถานะเช็ค
												</a>
											</li>';
