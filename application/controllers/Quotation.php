		...
		foreach ($list as $quotation) {
			...
			$str='';
			        if($quotation->sales_status!='')
			          $str="<span title='Converted to Sales Invoice' class='label label-success' style='cursor:pointer'> แปลงเป็นขาย </span>";
										...
										<ul role="menu" class="dropdown-menu dropdown-light pull-right">';
											...
											$str2.='<li>
												<a title="Convert to Invoice" href="'.base_url().'sales/quotation/'.$quotation->id.'" >
													<i class="fa fa-fw fa-exchange text-blue"></i>แปลงเป็นใบเสร็จขาย
												</a>
											</li>';
											...
											$str2.='<li>
												<a title="View to Invoice" href="'.base_url().'sales/invoice/'.get_sales_id_of_quotation($quotation->id).'" >
													<i class="fa fa-fw fa-eye text-blue"></i>ดูข้อมูลการขาย
												</a>
											</li>';
											...
											$str2.='<li>
												<a title="View Invoice" href="'.base_url().'quotation/invoice/'.$quotation->id.'" >
													<i class="fa fa-fw fa-eye text-blue"></i>ดูใบเสนอราคา
												</a>
											</li>';
											...
											$str2.='<li>
												<a title="Take Print" target="_blank" href="'.base_url().'quotation/print_invoice/'.$quotation->id.'">
													<i class="fa fa-fw fa-print text-blue"></i>พิมพ์ใบเสนอราคา
												</a>
											</li>
